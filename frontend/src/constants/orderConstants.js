...
export const CANCEL_MY_ORDERS_REQUEST = "CANCEL_MY_ORDERS_REQUEST";
export const CANCEL_MY_ORDERS_SUCCESS = "CANCEL_MY_ORDERS_SUCCESS";
export const CANCEL_MY_ORDERS_FAIL = "CANCEL_MY_ORDERS_FAIL";
